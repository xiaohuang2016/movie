        ...
        <div class="slider">
          <div class="callbacks_container">
            <div class="rslides" id="slider">
              <el-carousel trigger="click" :autoplay="true" height="500px">
                    ...
                    <el-row :gutter="20">
                      <el-col :span="17">
                        <ul class="list_1">
                          <el-col :span="8">
                            <li>
                              Published <span class="m_1">Feb 20, 2015</span>
                            </li>
                          </el-col>
                          <el-col :span="8">
                            <li>
                              Updated <span class="m_1">Feb 20 2015</span>
                            </li>
                          </el-col>
                          <el-col :span="8">
                            <li>
